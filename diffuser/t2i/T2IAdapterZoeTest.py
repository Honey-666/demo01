...
t2i_depth_recolor_path = 'C:\\work\\pythonProject\\aidazuo\\models\\T2I\\t2i-adapter-depth-zoe-sdxl-1.0'
...
img_path = 'C:\\work\\pythonProject\\aidazuo\\jupyter-script\\test-img\\org_zeo.jpg'
...
pre_img = img_zoe(im, model_path, detect_resolution=512, image_resolution=1024)
pre_img.show()
