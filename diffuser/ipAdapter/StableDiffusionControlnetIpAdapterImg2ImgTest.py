...
ref_img_path = 'C:\\work\\pythonProject\\aidazuo\\jupyter-script\\test-img\\20231125-153034.jpg'
...
canny_img = Image.open(canny_img_path).resize((512, 768))
depth_img = Image.open(depth_img_path).resize((512, 768))
