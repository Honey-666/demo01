...
class StableDiffusionControlNetInpaintReferencePipeline(DiffusionPipeline, TextualInversionLoaderMixin,
                                                        LoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        # 6. Preprocess mask and image - resizes image and mask w.r.t height and width
        ...
        # 9. Prepare reference latent variables
        ...
        # 9. Prepare mask latent variables
        ...
        # -------------------------process reference start----------------------------
        # 11. Modify self attention and group norm
        MODE = "write"
        uc_mask = (
        ...
        # 11.1 Create tensor stating which controlnets to keep
        controlnet_keep = []
...
source_img = Image.open('source_img.jpg')
mask_img = Image.open('mask_img.jpg')
control_img = Image.open('../canny/control_img.png')

controlnet = ControlNetModel.from_pretrained(
    "C:\\work\\pythonProject\\aidazuo\\models\\ControlNet\\control-v11p-sd15-canny",
    torch_dtype=torch.float16,
    variant="fp16")

pipe = StableDiffusionControlNetInpaintReferencePipeline.from_pretrained(
    "C:\\work\\pythonProject\\aidazuo\\models\\Stable-diffusion\\stable-diffusion-v1-5",
    controlnet=controlnet,
    torch_dtype=torch.float16)
...
image = pipe(
    prompt='cobalt blue,dodger blue, light salmon, coral red,Floral pattern, Vector Flower Pattern Leaves, High Contrast, sharp focus, highly detailed, detail, random, low saturation, 8k, hi-res',
    negative_prompt='',
    image=source_img,
    mask_image=mask_img,
